 ...
 *  \copydetails Group_BoardInfo_MODELM
 *
 ...
 *  \defgroup Group_BoardInfo_MODELM MODELM
 *  \brief Board specific information header for the IBM Model M USB board.
 *
 *  Board specific information header for the IBM Model M USB board (http://www.schwingen.org/modelm-usb/).
 *
 *  @{
 */

#ifndef __BOARD_MODELM_H__
#define __BOARD_MODELM_H__
